...
Invoke-WebRequest "$baseUrl/wasm-libopenjtalk.a" -OutFile library\full\resources\browser-wasm\openjtalk.a
...
Invoke-WebRequest "$baseUrl/wasm-libopenjtalk-lang.a" -OutFile library\lang\resources\browser-wasm\openjtalk-lang.a
