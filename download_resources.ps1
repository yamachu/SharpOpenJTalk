$latestInfo = Invoke-WebRequest https://github.com/yamachu/LibOpenJTalk/releases/latest -Headers @{"Accept"="application/json"}
...
Invoke-WebRequest "$baseUrl/Linux_libopenjtalk.so" -OutFile library\resources\linux\libopenjtalk.so
